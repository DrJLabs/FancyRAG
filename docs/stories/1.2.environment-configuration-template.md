...
3. Guidance captures default OpenAI model selections (`gpt-5-mini` baseline, optional fallback `gpt-4o-mini`) and references service endpoints so configuration aligns with PRD expectations. [Source: prd.md#functional] [Source: architecture.md#high-level-overview]
