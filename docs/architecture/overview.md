...
- `scripts/run_local_stack_smoke.sh` mirrors the CI smoke workflow locally by preparing a sanitized env file and running the compose-backed test. Set `OPENAI_API_KEY` before running.
