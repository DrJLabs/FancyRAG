...
|-----------------|-------|----------|-------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|-----------|
| 2.3-UNI-001     | Unit  | P0       | Instantiate shared client without overrides; assert baseline chat model == `gpt-5-mini` and embedding dims 1024. | Confirms defaults align with PRD/architecture expectations.     | TECH-230 |
...
| 2.3-UNI-004     | Unit  | P0       | Call embedding helper with 1024-length vector; expect pass/no logs.                                   | Happy path coverage for embeddings.                              | DATA-230 |
