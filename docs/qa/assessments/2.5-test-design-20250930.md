...
|-----------------|-------|----------|----------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|-----------|
| 2.5-UNI-001     | Unit  | P0       | Validate CLI/options default to `chunks_vec`, 1024 dims, cosine similarity, and honour `.env` overrides.            | Guards against misconfigured index parameters before runtime.                      | TECH-250 |
