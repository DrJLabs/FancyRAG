...
#### AC2: Provide embeddings helper enforcing 1024-dimension vectors, failing fast on mismatch, guiding remediation, and honoring intentional overrides.
- Coverage: FULL
- Test Mappings:
  - test_file: tests/unit/cli/test_utils.py::test_embedding_happy_path
    given: Embedding vector of length 1024
