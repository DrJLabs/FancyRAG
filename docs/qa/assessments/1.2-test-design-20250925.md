...
| ID              | Level       | Priority | Test Description                                                                    | Justification                                  | Mitigates |
|-----------------|-------------|----------|--------------------------------------------------------------------------------------|------------------------------------------------|-----------|
| 1.2-UNI-004     | Unit        | P0       | Assert `.env.example` includes `OPENAI_MODEL=gpt-5-mini` (commented default) and mentions optional `gpt-4o-mini`. | Locks model defaults to PRD expectations. | TECH-201 |
